...
protected:
	...
	virtual void OnCtrlLeftClick(const struct FInputActionInstance& Instance) override;
	virtual void OnCtrlRightClick(const struct FInputActionInstance& Instance) override;
};
